...
import { ToastNotificacaoComponent } from './core/components/toast-notificacao.component';

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, RouterLink, RouterLinkActive, CommonModule, ToastNotificacaoComponent],
